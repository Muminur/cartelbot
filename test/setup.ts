...
process.env.PAYMENT_WALLET_ADDRESS = 'T123456789012345678901234567890123';
process.env.DISCORD_WEBHOOK_SECRET = 'test-discord-webhook-secret-key-minimum-32-chars';
